...
Vue.component('layoutist-template', {
    props: ['data'],
    template: '#tmpl-layoutist-template',
    methods: {
        showPreview() {
...
var app = new Vue({
    ...
    data: {
      ...
      installedPlugins: layoutist.installed_plugins,
      activePlugins: layoutist.active_plugins,
    },
    computed: {
    ...
    methods: {
        infiniteHandler($state) {
          axios.get('https://technippy.com/layoutist/wp-json/layoutist/v1/templates/', {
            params: {
              page: this.page,
            },
          })
        ...
        togglePreview (event) {
          ...
          document.getElementsByClassName('layoutist-import-feedback')[0].innerHTML = '';
        },
        ...
        activatePlugin (plugin) {
          ...
          params.append('nonce', layoutist.nonce);
          params.append('action', 'layoutist');
        ...
        purchasePlugin: function (plugin) {
          window.open(layoutist.elementor_pro_url, '_blank')
        },
        ...
        isPluginPremium: function (plugin) {
          return 'elementor-pro/elementor-pro.php' === plugin ? true : false
        },
        importTemplate: function(templateId) {
          var button = event.target
          var feedback = document.getElementsByClassName('layoutist-import-feedback')[0]
          var params = new URLSearchParams();
          ...
          axios
            ...
            .then(response => {
              ...
              feedback.innerHTML = 'Imported <a href="' + data.url + '" target="_blank">' + data.title + '</a> in <a href="' + layoutist.elementor_save_templates_url + '" target="_blank">Saved Templates</a>.'
            })
            .catch(function (error) {
              console.log(error);
            })
